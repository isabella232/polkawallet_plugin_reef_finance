...
export const SubstrateNetworkKeys = Object.freeze({
  ...
  REEF_TESTNET: "0x0f89efd7bf650f2d521afef7456ed98dff138f54b5b7915cc9bce437ab728660",
});
...
const substrateNetworkBase = {
  [SubstrateNetworkKeys.REEF_TESTNET]: {
    color: "#173DC9",
    decimals: 18,
    genesisHash: SubstrateNetworkKeys.REEF_TESTNET,
    order: 42,
    pathId: "reef_testnet",
    prefix: 42,
    title: "Reef Testnet",
